...
> Act as the **devops** agent (`${CLAUDE_PLUGIN_ROOT}/agents/devops.md`).

The user wants to deploy or configure infrastructure: **$ARGUMENTS**
...
1. **Review architecture** — Read `docs/` (incl. `docs/architecture.md`) and `.co-agents/decisions.md` for infrastructure context
...
5. **Document** — Update `docs/` (e.g. `docs/architecture.md`) with infrastructure changes
