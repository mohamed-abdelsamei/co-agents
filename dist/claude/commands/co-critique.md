...
The user wants a critical review of: **$ARGUMENTS**
...
1. **Identify the target** — a decision (`decisions.md`), a plan (`tasks/`), requirements (`requirements/`), a research finding (`research/`), an architecture doc (`docs/`), or a raw idea in `$ARGUMENTS`. Load it and any linked context.
