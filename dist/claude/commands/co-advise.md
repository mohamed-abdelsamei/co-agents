...
The user wants strategic advice on: **$ARGUMENTS**
...
- For decisions: record in `.co-agents/decisions.md` once decided — set the `Informed by` field to any research doc or RFC that grounded it
