...
3. **Ask up to 3 batches of questions** (3-5 each) covering: quality standards, security rules, technical constraints, conventions, governance
...
Maximum **3 question rounds**. After round 3, produce the constitution with your best understanding. Mark unresolved areas with `[NEEDS CONFIRMATION]`.
